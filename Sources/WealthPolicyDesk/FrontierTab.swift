...
struct FrontierTab: View {
    ...
    private var notSolvableNotice: some View {
        Card("Efficient frontier") {
            Note("Nothing to solve yet. Enter the account balances and the retirement spending this household is planning for, and this chart will price the menu against the required return — not against the 20% clamp an empty plan used to print as a hurdle.",
