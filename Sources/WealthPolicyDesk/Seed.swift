...
public enum Seed {
    ...
    static let sleeves: [Sleeve] = [
        Sleeve(id: "us_large_core", label: "US Large Core", tier: .core, targetBps: 2600, bandBps: 500, maxBps: nil,
        ...
        Sleeve(id: "us_sector_tilt", label: "SPDR Sector Tilt", tier: .satellite, targetBps: 900, bandBps: 300, maxBps: 1200,
        ...
        Sleeve(id: "us_mid_small", label: "US Mid/Small", tier: .core, targetBps: 800, bandBps: 200, maxBps: nil,
        ...
        Sleeve(id: "intl_developed", label: "International Developed", tier: .core, targetBps: 1000, bandBps: 250, maxBps: nil,
        ...
        Sleeve(id: "emerging", label: "Emerging Markets", tier: .satellite, targetBps: 700, bandBps: 200, maxBps: nil,
        ...
        Sleeve(id: "real_assets", label: "Real Assets / REIT", tier: .diversifier, targetBps: 400, bandBps: 150, maxBps: 700,
               taxEfficiency: .low, locationPreference: [.taxDeferred, .taxFree], liquidityClass: .daily,
               instruments: [.init(ticker: "VNQ", role: .primary)],
               rationale: "Non-qualified dividends — sheltered accounts only. DISPLACED by home equity."),
        Sleeve(id: "fixed_income_liquid", label: "Liquid Fixed Income", tier: .liquidity, targetBps: 1600, bandBps: 400, maxBps: nil,
               taxEfficiency: .low, locationPreference: [.taxDeferred, .taxFree], liquidityClass: .daily,
               instruments: [.init(ticker: "BND", role: .primary)],
               rationale: "Sized to liquidity and rebalancing need, NOT to a target percentage. A conditional diversifier."),
    ]
